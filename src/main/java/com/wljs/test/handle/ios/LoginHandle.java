...
public class LoginHandle{
    ...
    private ResponseData isAppear(IOSDriver driver, StfDevicesFields fields, String text) {
     ...
     * @param driver
     */
    private void pressKeyPhone(IOSDriver driver, StfDevicesFields fields, int phoneTailNumber) {
     ...
     * @param driver
     */
    private void pressKeyVerificationCode(IOSDriver driver, StfDevicesFields fields) {
     ...
     * @param driver
     */
    private void pressKeyInvitationCode(IOSDriver driver, StfDevicesFields fields) {
