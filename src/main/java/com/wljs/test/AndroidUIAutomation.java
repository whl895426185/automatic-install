...
import com.wljs.test.handle.android.*;
 ...
 */
public class AndroidUIAutomation extends WaitElementHandle {
    ...
    private AndroidDriverUtil androidDriverUtil = new AndroidDriverUtil();
    ...
    private ResponseData fristStartApp(StfDevicesFields fields, DesiredCapabilities capabilities, int phoneNum) throws MalformedURLException {

        logger.info(":::::::::::::::::<<<" + fields.getDeviceName() + ">>>::::::::::::::::: 第1次启动未来集市APP");

        //启动APP
        driver = androidDriverUtil.initDriver(fields, capabilities);
...
//            loginHandle.login(driver, fields, phoneTailNumber);
     ...
     * 第二次启动
     */
    private ResponseData secondStartApp(StfDevicesFields fields, DesiredCapabilities capabilities, int phoneTailNumber) throws MalformedURLException {
